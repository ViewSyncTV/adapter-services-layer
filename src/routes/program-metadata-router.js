...
/**
 * Get the recommendations of a tv-show given its id (the id is the one from the TMDB API)
...
/**
 * Get the recommendations of a movie given its id (the id is the one from the TMDB API)
