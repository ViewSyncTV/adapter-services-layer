 ...
 * }
 */
router.get("/today", asyncHandler(dbController.getTodayTvProgram))
 ...
 * }
 */
router.get("/week", asyncHandler(dbController.getWeekTvProgram))
 ...
 * @name FavoriteAdd
 * @route {POST} /api/db/tv-program/favorite
 * @memberof API.TvProgram
 * @example
 * // Example of request
 * POST /api/db/tv-program/favorite
 * {
 ...
 * @name FavoriteRemove
 * @route {DELETE} /api/db/tv-program/favorite
 * @memberof API.TvProgram
 * @example
 * // Example of request
 * DELETE /api/db/tv-program/favorite
 * {
 *    "user_email": "test@email.com",
 ...
 * @name FavoriteGet
 * @route {GET} /api/db/tv-program/favorites
 * @routeparam {string} :userMail - The email of the user
 * @memberof API.TvProgram
 * @example
 * // Example of request
 * GET /api/db/tv-program/favorites/test%40mail.com%0A
 *
 * // Example of response
 * {
 *     "data": [
